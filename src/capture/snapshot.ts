...
/**
 * Minimum element size to be included in snapshot (64x64 pixels)
 */
const MIN_ELEMENT_SIZE = 64
...
function getBestSelector(element: HTMLElement): string {
  // Priority: data-testid > id > unique class > tag with nth-child
...
function isElementVisible(element: HTMLElement, rect: DOMRect): boolean {
  ...
  // Check size requirement (64x64 minimum)
